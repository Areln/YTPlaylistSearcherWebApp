...
@Component({
  selector: 'app-suika-clone',
  templateUrl: './suika-clone.component.html',
  styleUrls: ['./suika-clone.component.css'],
  encapsulation: ViewEncapsulation.None
})
export class SuikaCloneComponent implements OnInit {
